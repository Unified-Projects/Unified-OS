#ifndef __UNIFIED_OS_DRIVERS_INTEL_AHCI_H
#define __UNIFIED_OS_DRIVERS_INTEL_AHCI_H
...
namespace UnifiedOS{
    namespace Drivers{
        namespace AHCI{
            ...
            class AHCIPort : public FileSystem::DiskDevice{
            public: //Strucs and enums
                //Status
                enum AHCIStatus{
                    Uninitialized = 0,
                    Error = 1,
            ...
            private:
                ...
                HBACommandHeader* commandList; // Address Mapping of the Command List
                FIS_TYPE* fis; // Address Mapping of the FIS
            ...
            public:
                //Constructor
                AHCIPort(int num, HBAPort* portStructure, PortType port);
            ...
            protected:
                UnifiedOS::Devices::PCIDeviceHeader* PCIBaseAddress;
            public:
                //Setup
                AHCIDriver(UnifiedOS::Devices::PCIDeviceHeader* pciBaseAddress);
                ~AHCIDriver();
                ...
                //Maximum allowed port count is 32
                //Ports
                AHCIPort* Ports[32];
                uint8_t portCount;

            public: //Basic Dreiver Inheritance
                virtual void Activate(); //Probe Ports
                virtual int Reset();
