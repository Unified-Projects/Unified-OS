...
const char* UnifiedOS::to_string(uint64_t value){
    uint8_t size;
...
const char* UnifiedOS::to_string(int64_t value){
...
const char* UnifiedOS::to_hstring(uint64_t value){
...
const char* UnifiedOS::to_hstring(uint32_t value){
...
const char* UnifiedOS::to_hstring(uint16_t value){
...
const char* UnifiedOS::to_hstring(uint8_t value){
...
const char* UnifiedOS::to_string(double value, uint8_t dp){
    if(dp > 20){
        dp = 20;
    }
...
const char* UnifiedOS::to_string(double value){
...
int strlen(const char *str){
    ...
    return n; //Maybe Needs and extra 1
}
